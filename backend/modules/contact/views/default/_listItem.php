    ...
    <td>
        <span style="width: 250px;">
            <div class="d-flex align-items-center">
                ...
                <div class="ml-3">
                    <div class="text-dark-75 font-weight-bolder font-size-lg mb-0"><?=$model->first_name ?></div>
                    <a href="#" class="text-muted font-weight-bold text-hover-primary">Tel: <?=$model->phone?></a>
                </div>
            </div>
        </span>
