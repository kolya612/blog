                ...
                <div class="my-5">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            ...
                            ?>
                            <?=$form
                                ->field($formModel,'parent_id',['template' => '<label class="control-form-label col-xl-2">Parent:</label><div class="col-xl-10">{input}</div>',])
                        ...
                        <div class="col-xl-4">
                            ...
                            <div class="image-input image-input-outline" id="kt_image_1">
                                ...
                                echo \wbp\imageUploader\ImageUploader::widget([
                                    ...
                                    'data' => ['size' => '123x123'],
                                    'type' => \backend\modules\categories\models\Categories::$imageTypes[0],
