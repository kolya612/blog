                    ...
                    <div class="row">
                        <div class="col-xl-9">
                            ...
                            <?= $form->field($formModel, 'date',[
                                'template' => '<label class="control-form-label col-xl-2">Date:</label><div class="col-xl-10">{input}</div>',
                            ])
                                ->textInput(['maxlength' => true, 'class' => 'form-control form-control-solid row'])
                                ->label(false)
                            ?>
                            <?= $form->field($formModel, 'place',[
                                'template' => '<label class="control-form-label col-xl-2">Place:</label><div class="col-xl-10">{input}</div>',
                            ])
                                ->textInput(['maxlength' => true, 'class' => 'form-control form-control-solid row'])
                                ->label(false)
                            ?>
                        ...
                        <div class="col-xl-3">
                            ...
                            <div class="image-input image-input-outline" id="kt_image_1">
                                ...
                                echo \wbp\imageUploader\ImageUploader::widget([
                                    ...
                                    'data' => ['size' => '123x123'],
                                    'type' => \backend\modules\events\models\Events::$imageTypes[0],
                            ...
                            <div class="image-input image-input-outline" id="kt_image_1">
                                ...
                                echo \wbp\imageUploader\ImageUploader::widget([
                                    'style' => 'estoreMultiple',
                                    'data' => ['size' => '123x123'],
                                    'type' => \backend\modules\events\models\Events::$imageTypes[1],
                                    'item_id' => $formModel->id,
                                    'limit' => 1
                                ]);
                                ?>
